        		...
        		<div class="inside">
					...
					<div class="mod_article block" id="register">
						<div class="ce_text block">
							<h1>Contraseña para ingreso <font color="#e4790f"> <?=$datos[0]["nombre"]?> </font></h1>
						</div>
										...
										<fieldset>
											...
											<table summary="Personal data" >
											      ...
											      <tr class="even">
											        ...
											        <td class="col_1 col_last"><?=$datosTorneo[0]['torneo']?></td>   
											      </tr>  
											      <tr class="even">
											        <td class="col_0 col_first"><label for="nombre">Categoría</label></td>
											        <td class="col_1 col_last"><?=$datosTorneo[0]['categoria']?></td>    
											      </tr>  
												   <tr class="odd">
