<?	include_once "include/config.inc.php";
	...
	if ($_POST["id"] != -1) {
		...
		$oArbitros= new Arbitros();
		$datos = $oArbitros->get($_POST["id"]);
	}
?>
<!DOCTYPE HTML>
    		...
    		<div id="main">
        		<div class="inside">
					...
					<div class="mod_article block" id="register">
						<div class="ce_text block"><h1><?=$operacion?> de Arbitros</h1></div>
						<div class="mod_registration g8 tableform block">
							<form name="form_alta" id="form_alta" action="<?=$_SERVER['PHP_SELF']?>" method="post">
								...
								<div class="formbody">
									<div class="ce_table">
										<fieldset>
											<legend>Datos del Arbitro</legend>
						...
						<div class="ce_text g4 xpln block">
							<p><strong>Datos del Arbitro </strong><br/>Ingrese los datos del Arbitro </p>
