    ...
    <div id="cabezal1">
      ...
      <div id="imagen" style="float:left; vertical-align:top">
        ...
        <div style="float:left; margin-left:50px; width:90%">
          ...
          <div  style=" float:left; margin-left:-18px"> <img src="thumb/phpThumb.php?src=../fotos_beneficios/<?= $aBeneficios[$i]['fotoLogo']?>" width="145" height="70" border="0" hspace="8" vspace="8"></img></div>
          <? } ?>
          <div>
