										...
										foreach ($arreglo as $key => $valor) {
                                           ...
                                           <div id="fila" style="width:247px; height:30px; padding-top:10px; float:left;">
									   			<div class="jugadoras1" style="height:30px;">
													<?= $aJugadora[0]['nombre'] ?></div>
                                                <div class="tarjetas" style=" height:30px;"><?= $valor[amarillas] - $aJugadora[0][amarillas] ?></div>                     
                                                <div class="tarjetas" style=" height:30px; left:25px"><?= $valor[rojas] - $aJugadora[0][rojas] ?></div>                     
                                                <div class="tarjetas" style=" height:30px; left:70px"><?=  $aJugadora[0]['observaciones'] ?></div> 
                                           </div>     
