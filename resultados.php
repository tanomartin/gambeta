                 	...
                 	<div id="equipos" style="float:left">
                    	<? for ($i=0; $i<count($aEquipos);$i++) {
                            ...
                            if ($i % 2 == 0 )
                            	$clase = "0";
                        ?>
                        <div id=linea style="height:20px; width:125px; padding:7px; cursor:pointer" class="resultado_<?= $color ?>_<?= $clase?>" onclick="cambiarResultado(<?= $aEquipos[$i]['id'] ?>)" ><?= $aEquipos[$i]['nombre'] ?></div>
                       <? } ?> 
                    </div>
                    <div id="resultados" style="float:right; margin-left:10px" >
                        ...
                        <div id=linea style="height:19px; width:355px; padding:7px; border-top: #CCC 1px solid" >
                          <? if ($aFixture[$i]['idEquipo1']  == $aEquipos[0]['id']) { ?>
	                        ...
	                        <div style="width:15px; text-align:center; float:left" class=" resultado_equipo resultado_color_<?=$color?>"><b><?= ($aFixture[$i]['golesEquipo1']<0)? "-" :$aFixture[$i]['golesEquipo1'] ?></b></div>
	                        <div style="width:10px; text-align:left; float:left">&nbsp;</div>
	                        <div style="width:15px; text-align:center; float:left"  class="resultado_equipo"><b><?= ($aFixture[$i]['golesEquipo2']<0)? "-" :$aFixture[$i]['golesEquipo2']  ?></b></div>
                      	...
                      	<? } else  {?>                                                                   
	                        ...
	                        <div style="width:15px; text-align:center; float:left" class=" resultado_equipo resultado_color_<?=$color?>"><b><?= ($aFixture[$i]['golesEquipo2']<0)? "-" :$aFixture[$i]['golesEquipo2']  ?></b></div>
	                        <div style="width:10px; text-align:left; float:left">&nbsp;</div>
	                        <div style="width:15px; text-align:center; float:left"  class="resultado_equipo"><b><?= ($aFixture[$i]['golesEquipo1']<0)? "-" :$aFixture[$i]['golesEquipo1'] ?></b></div>
