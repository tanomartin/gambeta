         ...
         <div id="cabezal1">
			...
			<div id="imagen" style="float:left; vertical-align:top">
	            ...
	            <div id="fixture_<?= $color ?>">
            		<div  id="fixture_titulo" class="fixture_titulo1 fixture_color_<?= $color ?>"><?= strtoupper ($aFixture[0]['nombreFecha']) ?></div>
				...
				<a id="link_fixture" href="detalleFixture.php?color=<?= $color ?>&idEquipo1=<?= $aFixture[$p][idEquipo1]?>&idEquipo2=<?= $aFixture[$p][idEquipo2]?>&id=<?= $aFixture[$p][id]?>&keepThis=true&TB_iframe=true&height=600&width=600" title="" class="thickbox">
                    ...
                    <? $class = "fixture_color_".$color;
                   	...
                   	if ($aFixture[$p]['golesEquipo1'] >9) { ?>
                 	   <div id="fixture_resultado10" class="<?= $class ?>"><?= ($aFixture[$p]['golesEquipo1']>-1)?$aFixture[$p]['golesEquipo1']:""; ?></div>					
					<? } else {?>
                   	  <div id="fixture_resultado1" class="<?= $class ?>"><?= ($aFixture[$p]['golesEquipo1']>-1)?$aFixture[$p]['golesEquipo1']:""; ?></div>
					<? } ?>
                    ...
                    <? $class = "fixture_color_".$color;
                   	...
                   	if ($aFixture[$p]['golesEquipo2'] >9) { ?>
                 	   <div id="fixture_resultado20" class="<?= $class ?>"><?= ($aFixture[$p]['golesEquipo2']>-1)?$aFixture[$p]['golesEquipo2']:""; ?></div>					
					<? } else {?>
	                    <div id="fixture_resultado2" class="<?= $class ?>"><?= ($aFixture[$p]['golesEquipo2']>-1)?$aFixture[$p]['golesEquipo2']:""; ?></div>
				<? } ?>
