			...
			<div id="imagen" style="float:left; vertical-align:top">
			   ...
			   ?>
                    	<div class="goleadora_<?= $color ?>_<?= $pos ?>">
                        	<div class="posicion posicion_color_<?=$pos?>"><?= ($nro<10)? "0".$nro: $nro?></div>
                            <div class="nombreJugadora posicion_color_1"><?= $goleadoras[$i][nombre]  ?></div>
 							<div class="nombreEquipo posicion_color_1"><?= $goleadoras[$i][nombreEquipo]  ?></div>                  
							<div class="goles posicion_color_1"><?= $goleadoras[$i][goles] ?></div>                                                        
							<div class="partidos color_<?= $color ?>"><?= $goleadoras[$i][partidos]?></div>                                                        
