...
<? if ($modulo == 'beneficios' ) { ?>
		<div class="menu_borde_selec" id="menu_beneficios_seleccionada">
       </div> 
<? } else { ?>
		<div class="menu_borde" id="menu_beneficios" onclick="cambiar_menu('beneficios.php')">
        </div>    
<? } ?>
<? if ($modulo == 'fixture' ) { ?>
...
<? } ?>
<? if ($modulo == 'tarjetas' ) { ?>
		<div class="menu_borde_selec" id="menu_tarjetas_seleccionada">
       </div> 
<? } else { ?>
